    ...
    <section id="beneficios" className="container mx-auto max-w-7xl px-4 pt-4 mb-16 md:mb-32">
        <div className="flex flex-col items-center md:flex-row gap-8">
            <div className="flex flex-col items-center md:items-start gap-4 md:w-4/12">
                ...
                <a href="https://api.whatsapp.com/send?phone=51974309260" target="_blank" rel="noopener noreferrer" className="cta-custom-wsp bg-in-brown text-white px-8 py-3 rounded-full hidden md:block">Agendar cita</a>
            </div>
