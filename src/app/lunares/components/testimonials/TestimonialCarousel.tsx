...
import { TestimonialsData } from "@/app/hydrafacial/data/Testimonials.data";
  ...
  return (
    ...
    >
      {TestimonialsData.map((item) => (
        <SwiperSlide
          key={item.id}
          className="text-in-blue-base border border-[#FFECE3] bg-white rounded-xl shadow h-[300px] sm:h-[320px] md:h-[300px]"
        >
