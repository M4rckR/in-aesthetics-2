    ...
    <div className="container max-w-6xl mx-auto px-4">
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-1 text-lg text-in-brown">
            ...
            <p><span className="font-semibold">+</span> Yoga & Movimiento Consciente</p>
            <p><span className="font-semibold">+</span> Medicina Hormonal y Salud Femenina Integral</p>
            <p><span className="font-semibold">+</span> Experiencias InLuxury & Programas Combinados</p>
        </div>
      </section>
